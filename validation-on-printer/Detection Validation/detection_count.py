...
'''
files = ['speed/transfer/infill/MobileNet.txt',
         'speed/transfer/line/MobileNet.txt',
         'speed/real/infill/ResNet50.txt',
         'speed/real/line/ResNet50.txt',
         'speed/transfer/infill/ResNet50.txt',
         'speed/transfer/line/ResNet50.txt',
         'speed/real/infill/Xception.txt',
         'speed/real/line/Xception.txt',
         'speed/transfer/infill/Xception.txt',
         'speed/transfer/line/Xception.txt']
'''
files = ['speed/real/infill/Xception.txt',
         'speed/real/line/Xception.txt',
         'speed/transfer/infill/Xception.txt',
         'speed/transfer/line/Xception.txt']
for file_name in files:
    for i in range(5):
        ...
        f.write(f'start:{start}, end:{end}, num_detections:{num_detections}, avg_model_speed:{speed:.3f}\n')
        f.close()
