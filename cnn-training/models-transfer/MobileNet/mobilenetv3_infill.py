...
data_dir = pathlib.Path("data/real_data/augmented_real_infill/train")
...
name = "results/MobileNetV3Small_infill"
with tf.device('/device:GPU:1'):
    '''
    inp = layers.Input((img_h,img_h,3))
    x = MobileNetV3Small(input_tensor=inp, weights=None, include_top=False )
    ...
    '''
    model = tf.keras.models.load_model('results-synth/MobileNetV3Small_infill.h5')
