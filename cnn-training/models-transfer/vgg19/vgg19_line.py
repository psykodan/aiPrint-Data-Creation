...
with tf.device('/device:GPU:1'):
    ...
    '''
    model = tf.keras.models.load_model('results-synth/vgg19_line.h5')
    history = model.fit(train_ds, epochs=epochs, validation_data=val_ds, batch_size=64, callbacks=[es],verbose = 1)
